...
- The sticky currency panel must render as an opaque isolated scroll layer; scrolling its action list must not reveal or overlap other currency buttons behind it.
